...
public class Logic {
    ...
    private void createProcessIMD(Process process) throws ExcepcionDeAplicacion {
        ...
        try {
            ...
            for (String model : process.getModels()) {
                cell4Source.add("learner2MD_" + model.toLowerCase() + ",data=learn_with_model('dataset_MD1',models." + model.toLowerCase() + ")\n");
                cell4Source.add("listaModels2.append(learner2MD_" + model.toLowerCase() + ")\n");
            }
            cell4Source.add("omniModel('dataset_MD1',listaModels2," + process.getThreshold() + ")\n");
            
            for (String model : process.getModels()) {
                cell4Source.add("learner3MD_" + model.toLowerCase() + ",data=learn_with_model('dataset_MD1',models." + model.toLowerCase() + ")\n");
                cell4Source.add("learner3MD_" + model.toLowerCase() + ".export('/content/drive/My Drive/learnerMD_" + model.toLowerCase() + ".pkl')\n");
            }
